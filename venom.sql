...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 20-Out-2022 às 01:48
...
(9, 'Metodologia da Pesquisa Científica', 2, 45, 1, 2),
(10, 'Sociologia Aplicada a Administração', 2, 45, 1, 2),
(11, 'Introdução a Economia', 2, 60, 1, 2),
(12, 'Instituição de Direito Público e Privado', 2, 60, 1, 2),
(13, 'Matemática Aplicada a Administração I', 2, 60, 1, 2),
(14, 'Estatística e Probabilidade', 2, 45, 1, 2),
...
(22, 'Matemática Financeira', 4, 60, 1, 4),
(23, 'Direito Administrativo e Tributário', 4, 60, 1, 4),
(24, 'Administração de Sistemas de Informação', 4, 60, 1, 4),
(25, 'Contabilidade de Custos', 4, 60, 1, 4),
(26, 'Administração de Marketing II', 4, 60, 1, 4),
(27, 'Economia Brasileira Contemporânea', 4, 60, 1, 4),
(28, 'Projeto Interdisciplinar II', 4, 15, 1, 4),
...
(36, 'Administração da Produção II', 6, 60, 1, 6),
(37, 'Psicologia do Consumidor', 6, 45, 1, 6),
(38, 'Teoria da Decisão', 6, 60, 1, 6),
(39, 'Administração de Serviços', 6, 45, 1, 6),
(40, 'Empreendedorismo e Desenvolvimento Gerencial', 6, 45, 1, 6),
(41, 'Administração de Recursos Materiais', 6, 60, 1, 6),
(42, 'Gestão Pública', 6, 45, 1, 6),
(43, 'Projeto Interdisciplinar IV', 6, 15, 1, 6),
...
(51, 'Ética Profissional', 8, 45, 1, 8),
(52, 'Elaboração e Gerenciamento de Projetos', 8, 60, 1, 8),
(53, 'Logística Internacional', 8, 60, 1, 8),
(54, 'Comércio Exterior', 8, 60, 1, 8),
(55, 'TCC I', 8, 45, 1, 8),
(56, 'Estágio Supervisionado I', 8, 180, 1, 8),
(57, 'TCC II', 9, 45, 1, 9),
(58, 'Estágio Supervisionado II', 9, 180, 1, 9);
...
(8, 'Eletricidade e Circuitos para Computação I', 2, 60, 1, 2),
(9, 'Circuitos Lógicos II ', 2, 60, 1, 2),
(10, 'Calculo Diferencial e Integral II', 2, 75, 1, 2),
(11, 'Física Geral I', 2, 75, 1, 2),
(12, 'Laboratório de Física I', 2, 30, 1, 2),
(13, 'Álgebra Linear', 2, 60, 1, 2),
(14, 'Linguagem de Programação I ', 2, 60, 1, 2),
(15, 'Laboratório de Linguagem de Programação I', 2, 30, 1, 2),
(16, 'Química Geral e Inorgânica', 2, 60, 1, 2),
...
(24, 'Banco de Dados I ', 4, 60, 1, 4),
(25, 'Eletrônica Aplicada I', 4, 60, 1, 4),
(26, 'Arquitetura de Computadores', 4, 60, 1, 4),
(27, 'Física Geral III ', 4, 60, 1, 4),
(28, 'Laboratório de Física III ', 4, 30, 1, 4),
(29, 'Linguagem de Programação II ', 4, 60, 1, 4),
(30, 'Estatística e Probabilidade I', 4, 60, 1, 4),
...
(38, 'Concepção Estruturada de Circuitos Integrados', 6, 60, 1, 6),
(39, 'Micro controladores', 6, 60, 1, 6),
(40, 'Sistemas Embarcados I ', 6, 60, 1, 6),
(41, 'Sinais e Sistemas Dinâmicos ', 6, 60, 1, 6),
(42, 'Introdução a Computação Gráfica', 6, 60, 1, 6),
(43, 'Pesquisa Operacional', 6, 60, 1, 6),
...
(50, 'Engenharia de Software ', 8, 60, 1, 8),
(51, 'Inteligência Artificial I', 8, 60, 1, 8),
(52, 'Robótica', 8, 60, 1, 8),
(53, 'Teoria da Informação', 8, 60, 1, 8),
(54, 'Administração para Engenharia', 8, 60, 1, 8),
(55, 'Complementar Optativa III', 8, 60, 1, 8),
(56, 'Trabalho de Conclusão de Curso I', 9, 30, 1, 9),
(57, 'Computador e Sociedade ', 9, 60, 1, 9),
(58, 'Economia I ', 9, 60, 1, 9),
(59, 'Complementar Optativa IV', 9, 60, 1, 9),
(60, 'Testes de Software ', 9, 60, 1, 9),
(61, 'Projeto de Inovação Tecnológica', 9, 60, 1, 9),
(62, 'Trabalho de Conclusão de Curso II', 10, 30, 1, 10),
(63, 'Estagio Supervisionado', 10, 300, 1, 10);
...
(8, 'Sociologia da Educação', 2, 60, 1, 2),
(9, 'História da Educação', 2, 60, 1, 2),
(10, 'Cálculo Diferencial II', 2, 75, 1, 2),
(11, 'Física Geral I', 2, 75, 1, 2),
(12, 'Laboratório de Física I', 2, 30, 1, 2),
(13, 'Álgebra Linear', 2, 60, 1, 2),
(14, 'Química Geral e Inorgânica', 2, 60, 1, 2),
...
(22, 'Didática', 4, 60, 1, 4),
(23, 'Inglês Instrumental', 4, 60, 1, 4),
(24, 'Libras', 4, 60, 1, 4),
(25, 'Física Geral III', 4, 75, 1, 4),
(26, 'Laboratório de Fisica III', 4, 30, 1, 4),
(27, 'Física Matemática I', 4, 90, 1, 4),
(28, 'Análise Vetorial', 4, 60, 1, 4),
...
(36, 'Prática de Ensino de Física I e II', 6, 60, 1, 6),
(37, 'Eletromagnetismo I', 6, 75, 1, 6),
(38, 'Física Moderna', 6, 75, 1, 6),
(39, 'Informática Aplicada ao Ensino de Física', 6, 60, 1, 6),
(40, 'Instrumentação para o Ensino de Física', 6, 60, 1, 6),
(41, 'Mecânica Clássica II', 6, 60, 1, 6),
...
(48, 'Estágio Supervisionado II', 8, 195, 1, 8),
(49, 'Monografia', 8, 30, 1, 8),
(50, 'Optativa I', 8, 60, 1, 8),
(51, 'Optativa II', 8, 60, 1, 8),
(52, 'Optativa III', 8, 60, 1, 8);
...
(8, 'Estatística', 2, 60, 1, 2),
(9, 'Cálculo Integral e Diferencial', 2, 60, 1, 2),
(10, 'Materiais de Construção', 2, 60, 1, 2),
(11, 'Desenho Arquitetônico I', 2, 45, 1, 2),
(12, 'Hidráulica Aplicada', 2, 60, 1, 2),
(13, 'Fundamentos da Computação', 2, 60, 1, 2),
(14, 'Topografia II', 2, 60, 1, 2),
...
(22, 'Desenho Assistido por Computador', 4, 75, 1, 4),
(23, 'Tecnologia das Construções', 4, 90, 1, 4),
(24, 'Mecânica dos Solos e Fundações', 4, 60, 1, 4),
(25, 'Estabilidade das Construções', 4, 75, 1, 4),
(26, 'Sistema Predial Hidráulico e Sanitário', 4, 75, 1, 4),
(27, 'Projeto Interdisciplinar I', 4, 15, 1, 4),
(28, 'Sistema Predial Elétrico e Telefônico', 5, 75, 1, 5),
...
(35, 'Gestão de Empreendimentos de Construção Civil', 6, 60, 1, 6),
(36, 'Gestão de Suprimentos', 6, 60, 1, 6),
(37, 'Contabilidade Básica', 6, 60, 1, 6),
(38, 'Orçamento de Obra', 6, 75, 1, 6),
(39, 'Projeto Interdisciplinar III', 6, 15, 1, 6),
(40, 'Legislação Urbana e Ambiental', 6, 60, 1, 6),
(41, 'Estágio Supervisionado I', 6, 100, 1, 6),
...
(46, 'TCC', 7, 60, 1, 7),
(47, 'Ética Profissional', 7, 45, 1, 7),
