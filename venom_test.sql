...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 13-Jul-2022 às 16:36
...
(1, 'Introdução a Engenharia da Computação', 1, 60, 0, 0),
(2, 'Metodologia de Pesquisa Científica', 1, 60, 0, 0),
(3, 'Circuitos Lógicos I', 1, 60, 0, 0),
(4, 'Cálculo Vetorial e Geometria Analítica', 1, 60, 0, 0),
(5, 'Cálculo Diferencial e Intergral I', 1, 90, 0, 0),
(6, 'Introdução a Programação', 1, 60, 0, 0),
(7, 'Laboratório de Introdução a Programação', 1, 45, 0, 0),
(8, 'Eletricidade e Circuitos para Computação I', 2, 60, 0, 0),
...
(18, 'Materiais para Micro e Nano Tecnologia', 3, 60, 0, 0),
(19, 'Estrutura de Dados', 3, 60, 0, 0),
(20, 'Equações Diferencias e Ordinárias', 3, 60, 0, 0),
(21, 'Cálculo Diferencial e Integral III', 3, 75, 0, 0),
(22, 'Física Geral II ', 3, 75, 0, 0),
(23, 'Laboratório de Física II ', 3, 30, 0, 0),
...
(31, 'Cálculo Numérico', 5, 60, 0, 0),
(32, 'Análise e Projeto de Algoritmo', 5, 60, 0, 0),
(33, 'Eletrônica Aplicada II ', 5, 60, 0, 0),
(34, 'Introdução à Microeletrônica', 5, 60, 0, 0),
(35, 'Rede de Computadores', 5, 60, 0, 0),
(36, 'Sistemas Operacionais I ', 5, 60, 0, 0),
(37, 'Introdução a Mecânica dos Fluidos', 5, 45, 0, 0),
(38, 'Concepção Estruturada de Circuitos Integrados', 6, 60, 0, 0),
(39, 'Micro controladores', 6, 60, 0, 0),
(40, 'Sistemas Embarcados I ', 6, 60, 0, 0),
(41, 'Sinais e Sistemas Dinâmicos ', 6, 60, 0, 0),
(42, 'Introdução a Computação Gráfica', 6, 60, 0, 0),
(43, 'Pesquisa Operacional', 6, 60, 0, 0),
(44, 'Sistemas de Controle e Automação', 7, 60, 0, 0),
(45, 'Avaliação e Desempenho de Sistemas Computacionais', 7, 60, 0, 0),
(46, 'Redes sem Fio', 7, 60, 0, 0),
(47, 'Processamento Digital de Imagens', 7, 60, 0, 0),
(48, 'Complementar Optativa I ', 7, 60, 0, 0),
(49, 'Complementar Optativa II', 7, 60, 0, 0),
...
--
-- Extraindo dados da tabela `effetivate`
--

INSERT INTO `effetivate` (`numero`, `query`, `data`) VALUES
('019', 'delete from user_ec where discId in (\"5\") and userId = \"10\"; ', '{\"ids\":[5]}');
...
(2, '016', 22, NULL, '00000000001', 'Rob Luan', 'rob@hotmail.com', 3, 2022, 1),
(3, '559892437964@c.us', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(4, '558391149309@c.us', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(5, '559881793097@c.us', 0, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(6, '559891185744@c.us', 9, '2026$30362027280202', NULL, 'Nadia Isabely Flávia', NULL, NULL, NULL, 0),
(7, '559891123747@c.us', 11, '20221TADMEJA0001', NULL, 'André Luiz Lima', 'kkkk@ifm.edu', NULL, NULL, 0),
(8, '017', 7, NULL, '00000000011', NULL, NULL, NULL, NULL, 0),
(9, '018', 7, '20201ENG.SIN0030', NULL, NULL, NULL, NULL, NULL, 0),
(10, '019', 20, NULL, '00000000001', 'Henrique Djordan Ferreira Chaves', 'henrickdjordan@gmail.com', 2, 2022, 0),
(11, '020', 0, NULL, NULL, NULL, NULL, NULL, NULL, 0);
...
INSERT INTO `user_ec` (`id`, `userId`, `discId`) VALUES
(1, 10, 1),
(2, 10, 2),
(3, 10, 3),
(4, 10, 4),
